...
<head>
    ...
    <title>Friend Finder | Validate User</title>
                    ...
                    <div class="reg-form-container">
                        ...
                        <div class="reg-options">
                            <ul class="nav nav-tabs">
                                <li><a href="otp-verification">otp verifivation</a></li>
                            </ul><!--Tabs End-->
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="login">
                                ...
                                <!--Login Form-->
                                <form method="post" action="{{route('website.otp-verification.post')}}" data-parsley-validate="" name="Login_form" id ="Login_form" form-inline="form-inline">
                                    @csrf()
                                    <div class="row">
                                        <div class="form-group col-xs-12">
                                            <label for="my-otp" class="sr-only">OTP</label>
                                            <input id="my-otp" class="form-control input-group-lg" type="number" name="otp_code" title="Enter Otp" placeholder="Your Otp Code" required />
                                            @error('otp_code')
                                    ...
                                    <p> <a href="reset-otp" class="text-white-50 ms-1">Reset Otp</a></p>
