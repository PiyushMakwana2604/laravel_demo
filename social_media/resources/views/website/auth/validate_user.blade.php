                    ...
                    <div class="reg-form-container">
                        ...
                        <div class="reg-options">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="website-validate">Register</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="login">
                                <h3>validate user</h3>
                                <p class="text-muted">validate your account</p>
                                <!--Login Form-->
                                <form method="post" action="{{route('website.validate.post')}}" data-parsley-validate="" name="Login_form" id="Login_form" form-inline="form-inline">
                                    @csrf()
                                    <div class="row">
