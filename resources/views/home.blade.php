        ...
        <div class="content">
            <div class="container">
                        ...
                        <div class="card-box">
                            ...
                            <div class="text-center">
                                <ul class="list-inline chart-detail-list">
                                    <li>
                                        <h5><i class="fa fa-circle m-r-5" style="color: #5fbeaa;"></i>Desktops
                                        </h5>
                                    </li>
                                    <li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card-box">
                            <a href="#" class="pull-right btn btn-default btn-sm waves-effect waves-light">View
                                All</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-actions-bar m-b-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><span data-plugin="peity-bar" data-colors="#5fbeaa,#5fbeaa"
                                                    data-width="80" data-height="30">5,3,9,6,5,9,7,3,5,2</span>
                                            </td>
                                            <td><img src="{{ asset('assets/images/products/iphone.jpg')}}"
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('assets/images/products/samsung.jpg')}}"
                                        ...
                                        <tr>
                                            <td><span data-plugin="peity-line" data-fill="#fff" data-stroke="#5fbeaa"
                                                    data-width="80" data-height="30">5,3,9,6,5,9,7,3,5,2</span>
                                            <td><img src="{{ asset('assets/images/products/imac.jpg')}}"
                                                    class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone
                                            </td>
                                        ...
                                        <tr>
                                            <td><span data-plugin="peity-pie" data-colors="#5fbeaa,#ebeff2"
                                                    data-width="30" data-height="30">1/5</span></td>
                                            <td><img src="{{ asset('assets/images/products/macbook.jpg')}}"
                                                    class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone
                                            </td>
                                        ...
                                        <tr>
                                            <td><span data-plugin="peity-bar" data-colors="#5fbeaa,#ebeff2"
                                                    data-width="80" data-height="30">5,3,9,6,5,9,7,3,5,2</span>
                                            </td>
                                            <td><img src="{{ asset('assets/images/products/lumia.jpg')}}"
