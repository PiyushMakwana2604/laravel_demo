        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="about-video set-bg" data-setbg="{{ asset('gym_assets/img/'.$about_us->image)}}">
                        <a href="https://www.youtube.com/watch?v=Oqw32w49KD0" class="play-btn video-popup mfp-iframe" ><i
                        ...
                        <div class="about-bar">
                            <div class="ab-item">
                                ...
                                <div id="bar1" class="barfiller">
                                    <span class="fill" data-percentage="{{$about_us->body_building}}"></span>
                                    <div class="tipWrap">
                                        <span class="tip"></span>
                                    </div>
                                </div>
                            ...
                            <div class="ab-item">
                                ...
                                <div id="bar2" class="barfiller">
                                    <span class="fill" data-percentage="{{$about_us->training}}"></span>
                                    <div class="tipWrap">
                                        <span class="tip"></span>
                                    </div>
                                </div>
                            ...
                            <div class="ab-item">
                                ...
                                <div id="bar3" class="barfiller">
                                    <span class="fill" data-percentage="{{$about_us->fitness}}"></span>
                                    <div class="tipWrap">
                                        <span class="tip"></span>
                                    </div>
                                </div>
            ...
            <div class="ts_slider owl-carousel">
                <div class="ts_item">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="ti_pic">
                                <img src="{{ asset('gym_assets/img/testimonial/testimonial-1.jpg')}}" alt="">
                            </div>
                            <div class="ti_text">
                ...
                <div class="ts_item">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="ti_pic">
                                <img src="{{ asset('gym_assets/img/testimonial/testimonial-2.jpg')}}" alt="">
                            </div>
                            <div class="ti_text">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt<br /> ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices
