...
!function($) {
    ...
    ChatApp.prototype.save = function() {
        ...
        if (chatText == "") {
            ...
            $('<li class="clearfix odd"><div class="chat-avatar"><img src="assets/images/avatar-5.jpg" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><p>' + chatText + '</p></div></div></li>').appendTo('.conversation-list');
            this.$chatInput.val('');
            this.$chatInput.focus();
