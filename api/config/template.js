exports.otpMail = function (result, callback) {
    var template = ``;
    callback(template)
};
exports.WelcomeEmail = function (result, callback) {
    ...
    <body>
        <h3>Hello ${result.first_name}</h3>
        <img src="${result.profile_image}"/><br>
        <h4>Welcome To NodeJs Trainning</h4><br>
        <h5>Welcome To Hyperlink Infosystem</h5><br>
        <p>Thank you</p>  <br>  
        <p>Best Regards</p><br>
    </body>
    </html>`;
...
exports.Loginmail = function (result, callback) {
    ...
    <body>
        <h3>Hello ${result.first_name}</h3>
        <h4>Login successfully</h4><br>
        <h5>Welcome To Hyperlink Infosystem</h5><br>
        <p>Thank you</p>  <br>  
        <p>Best Regards</p><br>
    </body>
    </html>`;
    callback(loginTemplate);
}

exports.sendOtp = function (otp_code, callback) {

    var sendOtpTemplate = `<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <body>
        <h4>Verify Your Otp</h4><br>
        <h5>Your Otp is :${otp_code}</h5><br>
        <p>Thank you</p>  <br>  
        <p>Best Regards</p><br>
    </body>
    </html>`;
    callback(sendOtpTemplate);
}

exports.resetPasswordEmail = function (request, result, resetLink, callback) {
    var emailBody = `
	   <!DOCTYPE html
   ...
   <head>
	...
	<title>Forgot Your Password?</title><!--[if (mso 16)]>
	  <style type="text/css">
			...
			<tr style="border-collapse:collapse">
			  <td class="es-adaptive" align="center" style="padding:0;Margin:0">
			    <table class="es-header-body"
				 ...
				 <tr style="border-collapse:collapse">
				   <td
					style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:20px;padding-right:20px;background-color:#e8e8e9"
					bgcolor="#e8e8e9" align="left">
					  ...
					  <tr style="border-collapse:collapse">
					    <td align="left" style="padding:0;Margin:0;width:560px">
						 <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
						   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
						   <tr style="border-collapse:collapse">
							<td class="es-m-p0l es-m-txt-c" align="center" style="padding:0;Margin:0;font-size:0px">
							  <a href="https://www.hyperlinkinfosystem.com/" target="_blank"
							    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#1376C8;font-size:14px"><img
								 src="https://www.businessofapps.com/wp-content/uploads/2017/08/logo_hyperlink.png"
								 alt
						   ...
						   <tr style="border-collapse:collapse">
							<td align="center"
							  style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;font-size:0"><img
							    src="https://mtrxxd.stripocdn.email/content/guids/CABINET_dd354a98a803b60e2f0411e893c82f56/images/23891556799905703.png"
							    alt
							    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
							    width="175"></td>
						   </tr>
							  ...
							  <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0"
							    ...
							    <tr style="border-collapse:collapse">
								 <td valign="top" align="center" style="padding:0;Margin:0;padding-right:10px"><img
									src="https://mtrxxd.stripocdn.email/content/assets/img/social-icons/logo-colored/facebook-logo-colored.png"
									alt="Fb" title="Facebook" width="32"
									style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
								 </td>
								 <td valign="top" align="center" style="padding:0;Margin:0;padding-right:10px"><img
									src="https://mtrxxd.stripocdn.email/content/assets/img/social-icons/logo-colored/twitter-logo-colored.png"
									alt="Tw" title="Twitter" width="32"
									style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
								 </td>
								 <td valign="top" align="center" style="padding:0;Margin:0;padding-right:10px"><img
									src="https://mtrxxd.stripocdn.email/content/assets/img/social-icons/logo-colored/instagram-logo-colored.png"
									alt="Ig" title="Instagram" width="32"
									style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
								 </td>
								 <td valign="top" align="center" style="padding:0;Margin:0;padding-right:10px"><img
									src="https://mtrxxd.stripocdn.email/content/assets/img/social-icons/logo-colored/youtube-logo-colored.png"
									alt="Yt" title="Youtube" width="32"
									style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
								 </td>
								 <td valign="top" align="center" style="padding:0;Margin:0;padding-right:10px"><img
									src="https://mtrxxd.stripocdn.email/content/assets/img/social-icons/logo-colored/linkedin-logo-colored.png"
							...
							<td align="center" style="padding:0;Margin:0">
							  <p
							    ...
							    Contact us: <a target="_blank"
								 ...
								 href="tel:123456789">7</a>285086971 | <a target="_blank"
								 href="mailto:your@mail.com"
								 style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#666666;font-size:14px">hlis@hyperlinkinfosystem.com</a>
							  </p>
							</td>
						   </tr>
						 </table>
			...
			<tr style="border-collapse:collapse">
			  <td style="padding:0;Margin:0;background-color:#fafafa" bgcolor="#fafafa" align="center">
			    <table class="es-footer-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center"
				 ...
				 <tr style="border-collapse:collapse">
				   <td
					style="Margin:0;padding-top:10px;padding-left:20px;padding-right:20px;padding-bottom:30px;background-color:#9596cb"
					bgcolor="#9596cb" align="left">
					    ...
					    <td align="left" style="padding:0;Margin:0;width:560px">
						 <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
						   ...
						   <tr style="border-collapse:collapse">
							<td align="center" style="padding:0;Margin:0">
							  <p
							    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'comic sans ms', 'marker felt-thin', arial, sans-serif;line-height:26px;color:#333333;font-size:17px">
							    <em>Thank You,&nbsp;</em></p>
							  <p
							    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'comic sans ms', 'marker felt-thin', arial, sans-serif;line-height:26px;color:#333333;font-size:17px">
							    <em>Hyperlink Infosystem</em></p>
							</td>
						   </tr>
						 </table>
					    </td>
						   ...
						   <tr style="border-collapse:collapse">
							<td align="center" style="padding:0;Margin:0">
							  <p
							    ...
							    This daily newsletter was sent to <a target="_blank" href="mailto:your@mail.com"
								 style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#333333;font-size:12px">hlis@hyperlinkinfosystem.com</a>
							    from Hyperlink Infosystem&nbsp;because you subscribed. If you would not like to
							    receive this email <a target="_blank"
